...
maxGens = [highMaxGen, mediumMaxGen, lowMaxGen, highMaxGen, mediumMaxGen, lowMaxGen, highMaxGen, mediumMaxGen, lowMaxGen]
averageFitnessList = []
...
plt.savefig("C:/Users/Arthur/OneDrive - UWE Bristol/Year 2/Artificial Intelligence II/Assignment/Graphs/Function2/Average Final Fitness with High Low Medium P and MAXGENs.png")
plt.show()