...
plt.savefig("C:/Users/Arthur/OneDrive - UWE Bristol/Year 2/Artificial Intelligence II/Assignment/Graphs/Function2/Showing Average Final Fitness with Varying Mutation Rate and Step MR= "+ str(minMutRate) + " " + str(maxMutRate) + " MS= " + str(minMutStep) + " " + str(maxMutStep) +".png", dpi=100)
plt.show()