...
overallAverageFitness = np.zeros(1000) #Change to MAXGEN
overallBestFitness = np.zeros(1000)
...
plt.ylabel("Fitness")
plt.title("FUNCTION 1 - PARAMETERS:\
     P="+str(P)+" N="+str(N)+" MIN="+str(MIN)+" MAX="+str(MAX)+" MUTRATE="+str(MUTRATE)+" MUTSTEP="+str(MUTSTEP))
plt.legend()
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
plt.savefig("C:/Users/Arthur/OneDrive - UWE Bristol/Year 2/Artificial Intelligence II/Assignment/Graphs/Function1/P="+ str(P) + "N="+ str(N) +"MINandMAX=" + str(MIN) +"-"+ str(MAX) + "MUTRATE=" + str(MUTRATE) + "MUTSTEP=" + str(MUTSTEP) + ".png", dpi=100)
plt.show()
