...
mediumMutStep = 14
lowMutStep = 8
mutRates = [highMutRate, highMutRate, highMutRate, mediumMutRate, mediumMutRate, mediumMutRate, lowMutRate, lowMutRate, lowMutRate]
mutSteps = [highMutStep, mediumMutStep, lowMutStep, highMutStep, mediumMutStep, lowMutStep, highMutStep, mediumMutStep, lowMutStep]
averageFitnessList = []
...
plt.title("Average Final Fitness with High Low Medium MUTRATE/STEPs.")

plt.savefig("C:/Users/Arthur/OneDrive - UWE Bristol/Year 2/Artificial Intelligence II/Assignment/Graphs/Function1/Average Final Fitness with High Low Medium MUTRATE MUTSTEPs.png")
plt.show()